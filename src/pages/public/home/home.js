    ...
    render(){
        ...
        return (
            <Fragment>
                {
                    userType === 'student'
                    ?   <BasicLayoutForStu title='系统提示' describe='本页用于向用户展示暂有功能与操作' history={this.props.history}>
                        <div className="bruce">
                            <ul className="bubble-bgwall">
                                ...
                                <li>有向图</li>
                                <li>无向图</li>
                                <div style={{position:'absolute',left:'5%',top:'10%',textAlign:'left' }}>
                                    <p style={{fontFamily:'Microsoft Yahei',fontWeight:'bold',color:'black'}}>
                                    <span style={{fontStyle:'italic',color:'#0000e3'}}>{userName}同学</span>，您好！本系统操作教程大致如下:
                                    <br/><br/>
                                    目前开放的功能模块主要是&nbsp;<span style={{fontStyle:'italic',color:'#0000e3'}}>作业图片上传功能。</span>&nbsp;
                                    <br/><br/>
                                    你可以在&nbsp;
